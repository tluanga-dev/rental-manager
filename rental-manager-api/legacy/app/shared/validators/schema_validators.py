...
class InventoryValidationMixin:
    ...
    @field_validator('rental_price_per_day', 'purchase_price')
    @classmethod
...
class EnhancedInventoryItemCreate(EnhancedBaseModel, InventoryValidationMixin):
    ...
    description: Optional[str] = Field(
        ...
        max_length=1000,
        examples=["Apple MacBook Pro 16-inch with M1 chip, 16GB RAM, 512GB SSD"]
    )
    ...
    condition: Optional[str] = Field(
        ...
        pattern="^(NEW|EXCELLENT|GOOD|FAIR|POOR)$",
        examples=["NEW"]
    )
