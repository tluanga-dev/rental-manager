...
from app.core.postgres_enums import SupplierTypeEnum, SupplierTierEnum, SupplierStatusEnum
...
class Supplier(RentalManagerBaseModel):
    ...
    supplier_type = Column(SupplierTypeEnum, nullable=False, comment="Type of supplier")
    ...
    supplier_tier = Column(SupplierTierEnum, nullable=False, default=SupplierTier.STANDARD.value, comment="Supplier tier")
    status = Column(SupplierStatusEnum, nullable=False, default=SupplierStatus.ACTIVE.value, comment="Supplier status")
