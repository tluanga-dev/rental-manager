...
class SystemService:
    ...
    async def _create_missing_company_setting(self, setting_key: str) -> None:
        """Create a missing company setting with default values."""
        company_settings_map = {
            "company_name": {
            ...
            "company_website": {
                "setting_name": "Company Website",
                "setting_value": "",
                "description": "Company website URL",
                "display_order": "7"
            },
            "company_tax_id": {
                "setting_name": "Company Tax ID",
                "setting_value": "",
                "description": "Company tax identification number",
                "display_order": "8"
            },
            "company_currency": {
                "setting_name": "Company Currency",
                "setting_value": "INR",
                "description": "Company default currency",
                "display_order": "9"
            },
            "company_logo_url": {
                "setting_name": "Company Logo URL",
                "setting_value": "",
        ...
        if setting_key in company_settings_map:
            setting_data = company_settings_map[setting_key]
            await self.create_setting(
                ...
                default_value=setting_data["setting_value"],
    ...
    async def initialize_default_settings(self) -> List[SystemSetting]:
        ...
        default_settings = [
            ...
            },
            {
                ...
                "validation_rules": {
                    "type": "timezone",
                    "choices": ["Asia/Kolkata", "UTC", "US/Eastern", "US/Central", "US/Mountain", "US/Pacific", "Europe/London", "Europe/Paris", "Asia/Tokyo", "Asia/Shanghai", "Australia/Sydney", "Asia/Dubai", "Asia/Singapore"]
                },
                "display_order": "4"
            },
    ...
    async def get_system_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'timezone': await self.get_setting_value('system_timezone', 'Asia/Kolkata'),
