...
class Category(RentalManagerBaseModel):
    ...
    def __init__(
        ...
        name: str,
        category_code: str,
        parent_category_id: Optional[str | UUID] = None,
    ...
    def _validate(self):
        ...
        if len(self.category_code) > 15:
            raise ValueError("Category code cannot exceed 15 characters")
        
        # Category code format validation (alphanumeric and dashes only)
        import re
        if not re.match(r'^[A-Z0-9\-]+$', self.category_code):
